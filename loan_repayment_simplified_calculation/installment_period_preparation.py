...
def prepare_mapping_batch_payment(input_mapping_batch_payment_path, sheet_name):
    ...
    batch_df['actual_payment_date'] = pd.to_datetime(batch_df['actual_payment_datetime']).dt.to_period('D')
    batch_df['batch_payment_date'] = pd.to_datetime(batch_df['batch_payment_datetime']).dt.to_period('D')
    batch_df['next_payment_date'] = pd.to_datetime(batch_df['next_payment_date']).dt.to_period('D')
